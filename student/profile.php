    ...
    #img_profile >  a > img {
      ...
      height: auto;
          ...
          <ul class="list-group  ">
              ...
              <li class="list-group-item text-right"><span class="pull-left"><strong>Strand</strong></span> <?php echo $resCourse->COURSE_NAME .'-'.$resCourse->COURSE_LEVEL; ?> </li>
                        ...
                        <div class="col-md-12">
                          <div class="rows">
                            <div class="col-md-8">
                              ...
                              "file">
                              <label class="file-upload" id="fileUploadLabel" for="photo" >
            <i class="fa fa-picture-o" aria-hidden="true"></i>  Choose Your Image
        </label>
                            </div>
