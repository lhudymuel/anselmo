...
?>
 <div class="row">
      <div class="col-lg-12">
       	 <div class="col-lg-6">
            <h1 class="page-header">List of Strand/Year  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
       		<div class="col-lg-6" >
				  	...
				  	<?php 
						...
						foreach ($cur as $result) {
						  ...
						  <ul class="dropdown-menu dropdown-user">
							  ...
							  <a title="Delete" href="controller.php?action=delete&id='.$result->COURSE_ID.'" class="btn btn-danger btn-xs" ><span>Delete</span> </a>
							  </li>						   
						  </ul>
						
						<a title="Edit" href="index.php?view=edit&id='.$result->COURSE_ID.'"  class="btn btn-primary btn-xs  ">Edit <span class="fa fa-pencil fw-fa"></span></a>
