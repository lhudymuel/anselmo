...
<form class="form-horizontal" method="post" >
  ...
  <div class="col-md-8"><h2>Student Information</h2></div>
    ...
    <tr>
      ...
      <tr>
        <td colspan="5"><div class="col-sm-12 content-footer">
<p><i class="fa fa-paperclip"></i>  Attachment Files</p>
	<div class="col-sm-12 slider">
    
		
  <?php
     $fileUrl = web_root . 'student/' . $res->file;

// Check if the file exists
if (!empty($res->file)) {
    echo "<h3>Download Form <a style=\"color: blue\" href=\"$fileUrl\">Here....</a></h3>";
} else {
   echo "<h3> No file Uploaded yet</h3>";
}
?>
      ...
      <td></td>
        ...
        <div class="form-group">
           <label for="enrollment_status" class="col-sm-2 control-label">Enrollment Status</label>
           <div class="col-sm-10">
